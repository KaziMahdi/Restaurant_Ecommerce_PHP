...
function view_sliders(){
    $sliders=SiteSliderDetail::filter();
    $html="";
...
<img src="img/home-slider/$slider->photo"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            ...
                            <div class="slider_text_box">
                               <div class="tp-caption bg_box" 
                                ...
                                <div class="tp-caption secand_text" 
                                    ...
                                    data-splitout="none" 
                                    data-responsive_offset="on" 
                                    data-elementdelay="0.05" >$slider->description
                                </div>
                                <div class="tp-caption third_text" 
                                    ...
                                    data-splitout="none" 
                                    data-responsive_offset="on" 
                                    data-elementdelay="0.05" >$slider->sub_name
                                </div>
                                <div class="tp-caption btn_text" 
                                    ...
                                    data-splitout="none" 
                                    data-responsive_offset="on" 
                                    data-elementdelay="0.05" ><a class="submit_btn_bg" href="#">$slider->table_name</a>
                                </div>
                            </div>
                            </li>
HTML;
