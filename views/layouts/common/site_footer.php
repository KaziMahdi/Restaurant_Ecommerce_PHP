            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <aside class="f_widget contact_widget">
                        ...
                        <ul>
                            <li><a href="#"><i class="fa fa-envelope"></i>kazimahdi@gmail.com</a></li>
                            <li><a href="#"><i class="fa fa-phone"></i>+88 01880203494</a></li>
                            <li><a href="#"><i class="fa fa-map-marker"></i>5011 E. Dhanmondi. Dhaka 32,<br /> Kathalbagan, CA 91106</a></li>
                        </ul>
                    </aside>
                </div>
                <div class="col-md-3">
            ...
            <div class="pull-left">
                <h5>
                    <p>
                        ...
                        </script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Mahdi</a>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
                </h5>
            </div>
